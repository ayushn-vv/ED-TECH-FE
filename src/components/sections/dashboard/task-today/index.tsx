...
import { Thumb6 } from 'data/images';
...
const taskDetails: TaskDetail[] = [
  ...
  { id: 2, details: 'Understand the basics of Adobe XD design.' },
  { id: 3, details: 'Jnderstand coding in Swift in mobile apple devices.' },
];
...
const CountdownTimer = ({ initialSeconds = 3600 }: { initialSeconds?: number }) => {
  ...
  return (
    <Stack direction="row" alignItems="center" spacing={1}>
      ...
      >
        {timeLeft > 0 ? `${formatTime(timeLeft)} out soon ` : 'Out now'}
      </Typography>
    </Stack>
  );
};
      ...
      <CardContent sx={{ px: 3, pt: 3, pb: 1 }}>
        <Box mb={2}>
          <Typography variant="subtitle1" color="text.primary" fontWeight={700}>
            Creating Awesome Apple Mobile Apps
          </Typography>
          <Typography variant="subtitle2" color="text.secondary">
            Swift UI, Figma, Adobe XD
          </Typography>
        </Box>
