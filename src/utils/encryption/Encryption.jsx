import  { CryptoJS, pidCrypt, pidCryptUtil } from './app-encryption-min';
...
function encryptUsingRSA(plainText,public_key) {
...
function getEncryptedParams(params,key) {
  var encryptionKey = "rq";
  var aesKey = getRandomString(10);
  var rsaEncryptedAesKey = encryptUsingRSA(aesKey,key);
  var encryptedBody = {};
